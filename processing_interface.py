...
"}")
        ...
        self.label_icon = QtWidgets.QLabel(self.container)
        self.label_icon.setGeometry(QtCore.QRect(10, 10, 34, 30))
        font = QtGui.QFont()
        font.setFamily("Gill Sans MT")
        font.setPointSize(14)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_title.setText(_translate("Form", "Processing images"))
